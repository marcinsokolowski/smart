...
# -norfi
cotter -absmem 64 -j 12 -timeres 4 -freqres 0.01 -edgewidth 80 -noflagautos  -m 20200601224229.metafits -noflagmissings -allowmissing -offline-gpubox-format -initflag 0 -o 1275085816_20200601224229.ms 1275085816_20200601224229*gpubox*.fits
